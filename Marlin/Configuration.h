...
#define MANUAL_Z_HOME_POS 256.7
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,540}  // default steps per unit for ultimaker 
#define DEFAULT_MAX_FEEDRATE          {300, 300, 4, 20}    // (mm/sec)    
